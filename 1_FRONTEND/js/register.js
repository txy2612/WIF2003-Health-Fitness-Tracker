...
async function submitRegister() {
    ...
    const backendErr = document.getElementById('err-backend');
    ...
    const payload = {
        ...
        gender: document.getElementById('regGender').value || undefined,
        weight: document.getElementById('regWeight').value || undefined,
        height: document.getElementById('regHeight').value || undefined,
        goal: document.getElementById('regGoal').value || undefined
    };

    const result = await window.AuthService.register(payload);
